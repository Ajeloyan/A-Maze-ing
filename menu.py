...
#     print(banner)
    # print(f"{CYAN}    ╔═════════════════════════╗")
    # print(f"    ║{RESET}  {BOLD}1.{RESET} Generate new maze   {CYAN}║")
    # print(f"    ║{RESET}  {BOLD}2.{RESET} Show/Unshow maze    {CYAN}║")
    # print(f"    ║{RESET}  {BOLD}3.{RESET} autre               {CYAN}║")
    # print(f"    ║{RESET}  {BOLD}q.{RESET} Quit                {CYAN}║")
    # print(f"    ╚═════════════════════════╝{RESET}")
